...
def replace_middle(input_list):
    ...
    # list_slice_beginning = input_list[:2]
    # list_slice_end = input_list[-2:]
    # # print list_slice_end
    # new_inputs = [42,37]
    # input_list = list_slice_beginning + new_inputs + list_slice_end
